...
import { Menu, Bell, Search, User, Settings, LogOut, Home, Users, FileText, BarChart3, Calendar, MessageSquare, Shield, ChevronDown, ChevronRight, Edit3, Clock, Activity, Briefcase } from 'lucide-react';
...
const AdminLayout = ({ currentPage, onPageChange }) => {
  ...
  const getPageTitle = (pathname) => {
    ...
    const isActive = (item) => {
      ...
      // Match if current path is the main menu (e.g. /appointments)
      if (path === `/${item.id}`) return true;

      // Match if any submenu is active
      if (item.submenu) {
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      submenu: [
        { label: 'All User', id: 'userlist' },
        { label: 'Ic Verification', id: 'userverificationlist' },
            ...
            <div className="admin-layout-modal-content">
              <div className="admin-layout-profile-section">
                <div className="admin-layout-profile-avatar-section">
                  ...
                  <button type="button" className="admin-layout-btn-secondary">Change Photo</button>
                </div>
                <div className="admin-layout-form-grid">
                  ...
                  <div className="admin-layout-form-group">
                    <label>Phone</label>
                    <input type="tel" defaultValue="+60 12-345 6789" className="admin-layout-form-input" />
                  </div>
                  <div className="admin-layout-form-group">
                    <label>Department</label>
                    <select className="admin-layout-form-select" defaultValue="Administration">
                  ...
                  <div className="admin-layout-form-group">
                    <label>Role</label>
                    <select className="admin-layout-form-select" defaultValue="Administrator">
